  ...
  return (
    <div className="min-h-screen bg-[#171614] flex flex-col items-center justify-center p-4">
      ...
      <div className="flex items-center gap-2 mb-8 animate-fade-in">
        <div className="w-3 h-3 rounded-full bg-[#ff2200] animate-pulse" />
        <h1 className="text-2xl font-bold tracking-tight text-white">ArogyaMap</h1>
      </div>

      {/* Login Card */}
      <div className="w-full max-w-md bg-[#1c1b19] border border-white/5 rounded-2xl p-8 shadow-2xl overflow-hidden relative group">
        {/* Subtle glow effect */}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#121211] border border-white/10 rounded-xl px-11 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-[#dc2626]/50 focus:border-[#dc2626] transition-all"
